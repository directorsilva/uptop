...
class RequeteCompleteController extends Controller
{
  ...
  public function getData(Request $request)
  {
    ...
    'tj_payment_method.image as payment_image','tj_requete.discount','tj_requete.tip_amount',
    'tj_requete.tax','tj_requete.montant','tj_requete.stops','tj_requete.user_info')
