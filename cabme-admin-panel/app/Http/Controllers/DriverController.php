...
class DriverController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('drivers.show')->with('driver', $driver)->with("vehicle", $vehicle)->with("rides", $rides)->with("currency", $currency)->with('transactions',$transactions)->with('driverRating',$driverRating);
    }
