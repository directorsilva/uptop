          ...
          <fieldset>
           ...
           <fieldset>
            ...
            <div class="form-group row width-50">
              ...
              <div class="col-7">
                <!-- <input type="text" class="form-control address_line1" name="brand" value="{{$vehicle->brand}}"> -->
            ...
            <div class="form-group row width-50">
              ...
              <div class="col-7">
                <!-- <input type="text" class="form-control user_first_name" name="model" value="{{$vehicle->model}}"> -->
            ...
            <div class="form-group row width-50">
              ...
              <div class="col-7">
               ...
               <!-- <div class="form-group row width-100">
                   ...
                   @if (!empty($vehicleImage) && file_exists(public_path('assets/images/vehicle'.'/'.$vehicleImage->image_path)) && !empty($vehicleImage->image_path))
