                ...
                <div class="col-12">
                    <div class="card pb-4">
                        ...
                        <div class="card-body">
                          ...
                          <div class="col-7">
                            <input type="number" class="form-control user_latitude" name="latitude">
                        ...
                        <div class="form-group row width-50">
                          ...
                          <div class="col-7">
                            <input type="number" class="form-control user_longitude" name="longitude">
                            <div class="form-text text-muted">{{trans('lang.user_longitude_help')}}</div>
                                            ...
                                            <!-- <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" class="form-control address_line1" name="address"
                      ...
                      <div class="col-7">
                        <input type="text" class="form-control user_phone" name="device_id" >
                                        ...
                                        <!-- <div class="form-check width-50">
                          <input type="checkbox" class="col-7 form-check-inline" id="notify" name="notify" value="yes">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <select class="form-control brand_id" name="brand">
                                                        ...
                                                        {{--<input type="text" class="form-control address_line1" name="brand" value="{{Request::old('brand')}}">--}}
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    ...
                                                    <div class="form-text text-muted">{{trans('lang.vehicle_km_help')}}</div>
                                                </div>
                                            </div>
                                            <div class="form-group row width-50">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" name="holder_name"
                                                           class="form-control" id="holderName">
                                            ...
                                            <div class="form-group row width-50">
                                                ...
                                                <div class="col-7">
                                                    <input type="text" name="other_information"
                                                           class="form-control" id="otherDetails">
