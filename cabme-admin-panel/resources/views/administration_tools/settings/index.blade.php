                                        ...
                                        @foreach($settings as $setting)
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.settings_panel_title')}}</label>
                                                    <div class="col-7">
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.settings_panel_footer')}}</label>
                                                    <div class="col-7">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control user_phone" name="email"
                                                ...
                                                <div class="form-group row width-50">
                                                    ...
                                                    <br>
                                                    <input type="color" class="ml-3" name="website_color"
                                                           id="website_color"
                                                           value="{{$setting->website_color}}">
                                                </div>
                                                <div class="form-group row width-50">
                                                    <label class="col-5 control-label">{{trans('lang.driverapp_color_settings')}}</label>
                                                    <br>
                                                    <input type="color" class="ml-3" name="driverapp_color"
                                                           id="driverapp_color" value="{{$setting->driverapp_color}}">
                                                </div>
                                                <div class="form-group row width-50">
                                                    <label class="col-5 control-label">{{trans('lang.adminpanel_color_settings')}}</label>
                                                    <br>
                                                    <input type="color" class="ml-3" name="adminpanel_color"
                                                           id="adminpanel_color" value="{{$setting->adminpanel_color}}">
                                                </div>
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.driver_radios')}} ({{$setting->delivery_distance}})</label>
                                                    <div class="col-7">
                                                        <input type="text" class="form-control user_phone"
                                                               name="driver_radios" id="driver_radios"
                                                               value="{{$setting->driver_radios}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row width-50">
                                                    ...
                                                    <div id="image_preview" style="padding-left: 15px;">
                                                        @if (file_exists(public_path('assets/images/'.$setting->app_logo)) && !empty($setting->app_logo))
                                                ...
                                                <div class="form-group row width-50">
                                                    ...
                                                    <input type="file" class="col-7" name="app_logo_small"
                                                           id="app_logo_small" onchange="readURL2(this);">
                                                    <div id="image_preview2" style="padding-left: 15px;">
                                                        @if (file_exists(public_path('assets/images/'.$setting->app_logo_small)) && !empty($setting->app_logo_small))
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="password" class="form-control address_line1"
                                                               name="map_key"
...
@endif
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control user_schedule_time"
                                                ...
                                                <div class="form-group row width-100">
                                                    <label class="col-3 control-label">{{trans('lang.trip_accept_reject_by_driver')}}</label>
                                                    <div class="col-7">
                                                        <input type="text"
                                                               class="form-control trip_accept_reject_by_driver"
...
@endif
                                                ...
                                                <div class="form-group row width-100">
                                                    ...
                                                    <div class="col-7">
                                                        <select name="show_ride_otp" id="show_ride_otp"
                                                                class="form-control">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-100">
                                                    <label class="col-3 control-label">{{trans('lang.minimum_deposit_amount')}}</label>

                                                    <div class="col-7">
                                                        <div class="control-inner">
                                                            <input type="number"
                                                                   class="form-control minimum_deposit_amount"
                                                ...
                                                <div class="form-group row width-100">
                                                    <label class="col-3 control-label">{{trans('lang.minimum_withdrawal_amount')}}</label>

                                                    <div class="col-7">
                                                        <div class="control-inner">
                                                            <input type="number"
                                                                   class="form-control minimum_withdrawal_amount"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.contact_us_email')}}</label>
                                                    <div class="col-7">
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.contact_us_phone')}}</label>
                                                    <div class="col-7">
                                                ...
                                                <div class="form-group row width-50">
                                                    <label class="col-3 control-label">{{trans('lang.contact_us_address')}}</label>
                                                    <div class="col-7">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group row width-50">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" class="form-control web_version"
                                                               name="web_version" id="web_version"
                                                               value="{{$setting->web_version}}">
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group col-12 text-center btm-btn">
                                    ...
                                    <a href="{!! route('settings') !!}" class="btn btn-default"><i
