                    ...
                    <div class="card-body">
                        ...
                        <div class="userlist-topsearch d-flex mb-3">
                            <div class="userlist-top-left">
                                <a class="nav-link" href="{{ route('driver_document.create')}}"><i class="fa fa-plus mr-2"></i>{{trans('lang.driver_document_create')}}</a>
                            </div>
                            ...
                            <table id="example24"
                                ...
                                <tr>
                                  <td class="delete-all"><input type="checkbox"
                                    ...
                                    <td class="action-btn">
                                        <a href="{{route('driver_document.edit', ['id' => $doc->id])}}"><i
