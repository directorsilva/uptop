        ...
        <!-- <div class="modal fade" id="countryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">{{trans('lang.country_create')}}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                  <span aria-hidden="true">&times;</span>
                                                </button>
                                              </div>
                                            ...
                                            @endif
                                              <div class="modal-body">
                                              <form action="{{route('country.store')}}" method="post" id="create_country" enctype="multipart/form-data">
                                                @csrf

                                                <div class="form-group">
                                                <label>{{trans('lang.Name')}}</label>
                                                <input type="text" class="form-control libelle" name="libelle" value="">
