...
import 'package:cabme_driver/model/paypalErrorSettle.dart' as payPalErrorSettle;
...
import 'package:cabme_driver/page/wallet/paypalClientToken.dart';
...
import 'package:cabme_driver/model/paypal_currency_code_error_model.dart'
    as payPalCurrModel;
import 'package:cabme_driver/model/paypalPaymentSettle.dart' as payPalSettel;
...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetX<WalletController>(
        ...
        initState: (state) => walletController.getTrancation(),
