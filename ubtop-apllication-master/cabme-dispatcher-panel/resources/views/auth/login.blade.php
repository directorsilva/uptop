                    ...
                    <div class="form-group text-center m-t-20 mb-0">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group default-admin">
                                <div class="crediantials-field">Email:<span id="email_field">dispatcher@cabme.com</span><a
                                            href="javascript:void(0)" onclick="copyToClipboard('admin@cabme.com')"><i
                                                class="fa fa-copy"></i></a></div>
                                <div class="crediantials-field">Password:<span id="paassword_field">12345678</span><a
                                            href="javascript:void(0)" onclick="copyToClipboard('12345678')"><i
                                                class="fa fa-copy"></i></a></p></div>
                            </div>
