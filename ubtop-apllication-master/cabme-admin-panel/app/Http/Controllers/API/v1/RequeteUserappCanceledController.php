...
use DB;
class RequeteUserappCanceledController extends Controller
{
  ...
  public function getData(Request $request)
  {
    ...
    ->select('tj_requete.id', 'tj_requete.id_user_app', 'tj_requete.distance_unit','tj_requete.depart_name', 'tj_requete.destination_name', 'tj_requete.latitude_depart', 'tj_requete.longitude_depart', 'tj_requete.latitude_arrivee', 'tj_requete.longitude_arrivee', 'tj_requete.heure_retour', 'tj_requete.statut_round', 'tj_requete.number_poeple', 'tj_requete.place', 'tj_requete.statut', 'tj_requete.id_conducteur', 'tj_requete.creer', 'tj_requete.trajet', 'tj_requete.trip_objective', 'tj_requete.trip_category', 'tj_user_app.nom', 'tj_user_app.prenom', 'tj_requete.distance',
    'tj_user_app.phone', 'tj_conducteur.nom as nomConducteur',
    'tj_conducteur.prenom as prenomConducteur', 'tj_conducteur.phone as driverPhone',
    'tj_conducteur.photo_path', 'tj_requete.date_retour', 'tj_requete.montant',
     'tj_requete.duree', 'tj_requete.statut_paiement', 'tj_payment_method.libelle as payment',
     'tj_payment_method.image as payment_image','tj_requete.stops')
    ...
    ->whereIn('tj_requete.statut',['canceled', 'rejected'])
    ...
    foreach($sql as $row){
        ...
        if($id_conducteur != 0){
            ...
            ->get();
                ...
                //$row->nb_avis_driver = $row_nb_avis_driver->nb_avis_driver;
