...
use DB;
class RequeteBookUserappController extends Controller
{
  ...
  public function getData(Request $request)
  {
    ...
    ->where('tj_requete_book.id_user_app','=',$id_user_app)
