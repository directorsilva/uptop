...
class RequeteUserappController extends Controller
{
            ...
            ->get();
                ...
                foreach($sql_note_driver as $row_note_driver){
                    if(!empty($row_note_driver)){
                        // if($row_note_driver->niveau_driver !=0){
                        // $row->niveau_driver = number_format((float)$row_note_driver->niveau_driver, 2, '.', '');
                        // }else{
                        //     $row->niveau_driver = 0;
                        // }
