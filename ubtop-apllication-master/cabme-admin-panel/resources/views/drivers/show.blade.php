                    ...
                    <div class="card">
						...
						<div class="user-detail" role="tabpanel">
						    ...
						    <ul class="nav nav-tabs">
						        ...
						        <li role="presentation" class="">
						        	<a href="#vehicle" aria-controls="vehicle" role="tab" data-toggle="tab" class="{{ (Request::get('tab') == 'vehicle') ? 'active show' : '' }}">Vehicle</a></li>

						        <li role="presentation" class="">
						        	<a href="#transaction" aria-controls="transaction" role="tab" data-toggle="tab" class="{{ (Request::get('tab') == 'transaction') ? 'active show' : '' }}">Wallet Transaction</a></li>
										...
										<div class="col-md-6">
		                                  	<div class="col-group">
		                                    	...
		                                    	<span>
													...
													{{number_format($driver->amount,$currency->decimal_digit)."".$currency->symbole}}
													@else
													{{$currency->symbole."".number_format($driver->amount,$currency->decimal_digit)}}
													@endif
												</span>
		                                	</div>
										</div>
												...
												<tr>
			                                        ...
			                                        <td>
														@if($currency->symbol_at_right=="true")
															...
															<span style="color:red">(-{{number_format(substr($transaction->amount,1),$currency->decimal_digit)."".$currency->symbole }})</span>
															@else
															<span style="color:green">{{number_format($transaction->amount,$currency->decimal_digit)."".$currency->symbole }}</span>
															@endif
														@else
															@if(substr($transaction->amount,0,1)=="-")
															<span style="color:red">(-{{ $currency->symbole."".number_format(substr($transaction->amount,1),$currency->decimal_digit) }})</span>
															@else
															<span style="color:green">{{ $currency->symbole."".number_format($transaction->amount,$currency->decimal_digit) }}</span>
															@endif
