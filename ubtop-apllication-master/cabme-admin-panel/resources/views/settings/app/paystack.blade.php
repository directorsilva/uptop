        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
               <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active PayStack_active_label" href="{!! url('settings/payment/paystack') !!}"><i class="fa fa-envelope-o mr-2"></i>{{trans('lang.app_setting_paystack')}}<span class="badge ml-2"></span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body">
                ...
                <div class="row restaurant_payout_create">
                    <div class="restaurant_payout_create-inner">
                            <fieldset>
                                <legend><i class="mr-3 fa fa-cc-paystack"></i>{{trans('lang.app_setting_paystack')}}</legend>
                                @foreach($paystack as $data)
                                <input type="hidden" class="id" id="id"  value="{{$data->id}}">

                                <div class="form-check width-100">
                                    <input type="checkbox" class="enable_paystack" id="enable_paystack" value="{{$data->isEnabled}}" @if($data->isEnabled == 'true') checked=checked @endif>
                                    <label class="col-3 control-label" for="enable_paystack">{{trans('lang.active')}}</label>

                                   
                                </div>
                                <div class="form-check width-100">
                                    <input type="checkbox" class="sandbox_enable" id="sandbox_enable" @if($data->isSandboxEnabled == 'true') checked=checked @endif>
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="password" class="form-control paystack_key" value="{{ $data->secret_key }}">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="password" class=" col-7 form-control paystack_secret" value="{{ $data->public_key }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-100">
                                    <label class="col-3 control-label">{{trans('lang.app_setting_paystack_callback_url')}}</label>
                                    <div class="col-7">
                                        <input type="password" class=" col-7 form-control callback_url"  value="{{ $data->callback_url }}">
                                      
                                    </div>
                                </div>
                                <div class="form-group row width-100">
                                    <label class="col-3 control-label">{{trans('lang.app_setting_paystack_webhook_url')}}</label>
                                    <div class="col-7">
                                        <input type="password" class=" col-7 form-control webhook_url" value="{{ $data->webhook_url }}">
...
@section('scripts')
 ...
 <script>
  ...
  $(".save_stripe_btn").click(function(){
        ...
        var paystack_secret = $(".paystack_secret").val();
        var isPaystackEnabled = $(".enable_paystack").is(":checked");
        var issandboxEnabled = $(".sandbox_enable").is(":checked");
        var callback_url = $(".callback_url").val();
        var webhook_url = $(".webhook_url").val();
        var id = $(".id").val();
        var url = "{{ route('payment.paystackUpdate',':id') }}";
