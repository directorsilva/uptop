                    ...
                    <div class="card-body">
                        ...
                        <div class="userlist-topsearch d-flex mb-3">
                            ...
                            <div class="userlist-top-left">
                                <a class="nav-link" href="{!! route('vehicle-rental-type.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.create_rental_vehicle_type')}}</a>
                            </div>
                            ...
                            <table id="example24"
                                ...
                                <tr>
                                   ...
                                   {{-- <td>
                                    ...
                                    <td class="action-btn"><a class="edit_type_vehicle" href="{{route('vehicle-rental-type.edit', ['id' => $type->id])}}"><i
                                                    class="fa fa-edit"></i></a><a id="'+val.id+'" class="do_not_delete"
                                                                                  href="{{route('vehicle-rental-type.delete', ['id' => $type->id])}}"><i
