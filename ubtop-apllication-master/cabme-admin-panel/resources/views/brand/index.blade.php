                ...
                <div class="row">
                    ...
                    <div class="userlist-topsearch d-flex mb-3">
                                <div class="userlist-top-left">
                                 <a class="nav-link" href="{{ route('brand.create')}}" ><i class="fa fa-plus mr-2"></i>{{trans('lang.create_brand')}}</a>
                                </div>
                                    ...
                                    <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                        ...
                                        @if(count($brands) > 0)
                                            ...
                                            <td class="delete-all"><input type="checkbox"
                                                ...
                                                <td class="action-btn"><a href="{{route('brand.edit', ['id' => $brand->id])}}"><i class="fa fa-edit"></i></a>
