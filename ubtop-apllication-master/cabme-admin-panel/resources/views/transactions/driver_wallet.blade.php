                                    ...
                                    <!-- <td>{{ $data->id }}</td> -->
                                        ...
                                        <td>
                                         @if($currency->symbol_at_right=="true")
                                            ...
                                            <span style="color:red">(-{{number_format(substr($data->amount,1),$currency->decimal_digit)."".$currency->symbole }})</span>
                                            @else
                                            <span style="color:green">{{number_format($data->amount,$currency->decimal_digit)."".$currency->symbole }}</span>
                                            @endif
                                         @else
                                             @if(substr($data->amount,0,1)=="-")
                                               <span style="color:red">(-{{ $currency->symbole."".number_format(substr($data->amount,1),$currency->decimal_digit) }})</span>
                                             @else
