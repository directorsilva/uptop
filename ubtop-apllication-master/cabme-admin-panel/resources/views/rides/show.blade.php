                                                        ...
                                                        <div class="address order_detail-top-box user-details">
                                                            ...
                                                            <span class="billing_name d-flex">
                                                                @if(file_exists(public_path('assets/images/users'.'/'.$ride->photo_path)) && !empty($ride->photo_path))
                                                                        <span class="user-img"><img class="rounded"
                                                                                                    style="width:50px"
                                                                                                    src="{{asset('assets/images/users/'.$ride->photo_path)}}"
                                                                                                    alt="Image"></span>
                                                ...
                                                <div class="col-md-5 order-deta-btm-right">
                                                    <div class="resturant-detail">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <a href="#" class="row redirecttopage"
                                                                   id="resturant-view">
                                                                    <div class="col-4">
                                                                        @if (file_exists(public_path('assets/images/drivers'.'/'.$ride->driver_photo)) && !empty($ride->driver_photo))
                                                                            <span id="billing_name" class="d-flex"><span
                                                                                        class="user-img"><img
                                                                                            class="rounded"
                                                                                            style="width:50px"
                                                                                            src="{{asset('assets/images/drivers/'.$ride->driver_photo)}}"
                                                                                            alt="Image"></span>
                                                                        @else
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <p> @if(empty($customer_review)) {{trans("lang.no_review_found")}} 
                                                    @else{{$customer_review}}@endif</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <p>@if(empty($driver_review)){{trans('lang.no_review_found')}}@else{{$driver_review}}@endif</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
